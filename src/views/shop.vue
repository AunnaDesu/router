  ...
  data() {
    return {
        productlist: [
        {
          ...
          name: "KITO Move TwoTone AH81 (white&red)",
          imageurl:
            "https://www.kito.co.th/wp-content/uploads/2020/09/Kito-Move-TWOTONE-A-scaled.jpg",
          rightText: "price : 199",
...

        {
          ...
          name: "มนุษย์ป้าข้างบ้าน ที่พร้อมจะส่องเรื่องของคุณ",
          imageurl:
